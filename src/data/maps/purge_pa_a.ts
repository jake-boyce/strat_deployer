...
// Layout A (Purge Priority Assets)
...
//   scripts/output/purge_pa_a_template_qa.png before fully trusting.
...
export const purgePaA: MissionMap = {
  id: "purge_pa_a",
  name: "Layout A",
  ...
  sourceImage: "Purge_PA_A.png",
  imageCalibration: {
    src: "/map-images/Purge_PA_A.png",
    imageWidthPx: 870,
    imageHeightPx: 1160,
    pxOrigin: [65, 129],
