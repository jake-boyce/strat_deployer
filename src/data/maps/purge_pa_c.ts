...
// Layout C (Purge Priority Assets)
...
//   scripts/output/purge_pa_c_template_qa.png before fully trusting.
...
export const purgePaC: MissionMap = {
  id: "purge_pa_c",
  name: "Layout C",
  ...
  sourceImage: "Purge_PA_C.png",
  imageCalibration: {
    src: "/map-images/Purge_PA_C.png",
    imageWidthPx: 775,
    imageHeightPx: 1173,
    pxOrigin: [14, 110],
