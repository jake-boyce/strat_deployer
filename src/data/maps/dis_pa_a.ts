...
// Layout A (Disruption Priority Assets)
...
//   scripts/output/dis_pa_a_template_qa.png before fully trusting.
...
export const disPaA: MissionMap = {
  id: "dis_pa_a",
  name: "Layout A",
  ...
  sourceImage: "Dis_PA_A.png",
  imageCalibration: {
    src: "/map-images/Dis_PA_A.png",
    imageWidthPx: 859,
    imageHeightPx: 1142,
    pxOrigin: [54, 112],
