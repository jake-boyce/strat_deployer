...
//   scripts/output/dis_mirror_b_template_qa.png before fully trusting.
...
export const disMirrorB: MissionMap = {
  id: "dis_mirror_b",
  name: "Layout B",
  ...
  sourceImage: "Dis_Mirror_B.png",
  imageCalibration: {
    src: "/map-images/Dis_Mirror_B.png",
    imageWidthPx: 776,
    imageHeightPx: 1176,
    pxOrigin: [16, 105],
