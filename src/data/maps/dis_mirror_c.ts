...
//   scripts/output/dis_mirror_c_template_qa.png before fully trusting.
...
export const disMirrorC: MissionMap = {
  id: "dis_mirror_c",
  name: "Layout C",
  ...
  sourceImage: "Dis_Mirror_C.png",
  imageCalibration: {
    src: "/map-images/Dis_Mirror_C.png",
    imageWidthPx: 859,
    imageHeightPx: 1138,
    pxOrigin: [58, 111],
