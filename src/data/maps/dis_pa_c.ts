...
// Layout C (Disruption Priority Assets)
...
//   scripts/output/dis_pa_c_template_qa.png before fully trusting.
...
export const disPaC: MissionMap = {
  id: "dis_pa_c",
  name: "Layout C",
  ...
  sourceImage: "Dis_PA_C.png",
  imageCalibration: {
    src: "/map-images/Dis_PA_C.png",
    imageWidthPx: 857,
    imageHeightPx: 1140,
    pxOrigin: [56, 117],
