...
//   scripts/output/purge_recon_a_template_qa.png before fully trusting.
...
export const purgeReconA: MissionMap = {
  id: "purge_recon_a",
  name: "Layout A",
  ...
  sourceImage: "Purge_Recon_A.png",
  imageCalibration: {
    src: "/map-images/Purge_Recon_A.png",
    imageWidthPx: 773,
    imageHeightPx: 1184,
    pxOrigin: [10, 109],
