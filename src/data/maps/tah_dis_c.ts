...
//   scripts/output/tah_dis_c_template_qa.png before fully trusting.
...
export const tahDisC: MissionMap = {
  id: "tah_dis_c",
  name: "Layout C",
  ...
  sourceImage: "TAH_Dis_C.png",
  imageCalibration: {
    src: "/map-images/TAH_Dis_C.png",
    imageWidthPx: 783,
    imageHeightPx: 1185,
    pxOrigin: [16, 112],
