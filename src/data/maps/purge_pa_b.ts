...
// Layout B (Purge Priority Assets)
...
//   scripts/output/purge_pa_b_template_qa.png before fully trusting.
...
export const purgePaB: MissionMap = {
  id: "purge_pa_b",
  name: "Layout B",
  missionPack: "Purge Priority Assets",
  ...
  sourceImage: "Purge_PA_B.png",
  imageCalibration: {
    src: "/map-images/Purge_PA_B.png",
    imageWidthPx: 862,
    imageHeightPx: 1130,
    pxOrigin: [58, 104],
