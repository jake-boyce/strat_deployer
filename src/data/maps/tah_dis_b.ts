...
//   scripts/output/tah_dis_b_template_qa.png before fully trusting.
...
export const tahDisB: MissionMap = {
  id: "tah_dis_b",
  name: "Layout B",
  ...
  sourceImage: "TAH_Dis_B.png",
  imageCalibration: {
    src: "/map-images/TAH_Dis_B.png",
    imageWidthPx: 776,
    imageHeightPx: 1173,
    pxOrigin: [16, 112],
