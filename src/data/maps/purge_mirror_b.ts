...
//   scripts/output/purge_mirror_b_template_qa.png before fully trusting.
...
export const purgeMirrorB: MissionMap = {
  id: "purge_mirror_b",
  name: "Layout B",
  ...
  sourceImage: "Purge_Mirror_B.png",
  imageCalibration: {
    src: "/map-images/Purge_Mirror_B.png",
    imageWidthPx: 783,
    imageHeightPx: 1189,
    pxOrigin: [14, 116],
