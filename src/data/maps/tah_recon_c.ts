...
//   scripts/output/tah_recon_c_template_qa.png before fully trusting.
...
export const tahReconC: MissionMap = {
  id: "tah_recon_c",
  name: "Layout C",
  ...
  sourceImage: "TAH_Recon_C.png",
  imageCalibration: {
    src: "/map-images/TAH_Recon_C.png",
    imageWidthPx: 857,
    imageHeightPx: 1153,
    pxOrigin: [56, 108],
