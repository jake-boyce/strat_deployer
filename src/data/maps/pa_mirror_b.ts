...
// Layout B (Priority Assets Mirror)
...
//   scripts/output/pa_mirror_b_template_qa.png before fully trusting.
...
export const paMirrorB: MissionMap = {
  id: "pa_mirror_b",
  name: "Layout B",
  ...
  sourceImage: "PA_Mirror_B.png",
  imageCalibration: {
    src: "/map-images/PA_Mirror_B.png",
    imageWidthPx: 775,
    imageHeightPx: 1182,
    pxOrigin: [12, 113],
