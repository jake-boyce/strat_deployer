...
// Layout C (Recon Priority Assets)
...
//   scripts/output/recon_pa_c_template_qa.png before fully trusting.
...
export const reconPaC: MissionMap = {
  id: "recon_pa_c",
  name: "Layout C",
  ...
  sourceImage: "Recon_PA_C.png",
  imageCalibration: {
    src: "/map-images/Recon_PA_C.png",
    imageWidthPx: 864,
    imageHeightPx: 1139,
    pxOrigin: [60, 107],
