...
//   scripts/output/purge_dis_a_template_qa.png before fully trusting.
...
export const purgeDisA: MissionMap = {
  id: "purge_dis_a",
  name: "Layout A",
  ...
  sourceImage: "Purge_Dis_A.png",
  imageCalibration: {
    src: "/map-images/Purge_Dis_A.png",
    imageWidthPx: 875,
    imageHeightPx: 1154,
    pxOrigin: [64, 120],
