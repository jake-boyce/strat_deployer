...
//   scripts/output/purge_recon_b_template_qa.png before fully trusting.
...
export const purgeReconB: MissionMap = {
  id: "purge_recon_b",
  name: "Layout B",
  ...
  sourceImage: "Purge_Recon_B.png",
  imageCalibration: {
    src: "/map-images/Purge_Recon_B.png",
    imageWidthPx: 859,
    imageHeightPx: 1162,
    pxOrigin: [56, 132],
