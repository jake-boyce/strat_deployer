...
//   scripts/output/recon_mirror_b_template_qa.png before fully trusting.
...
export const reconMirrorB: MissionMap = {
  id: "recon_mirror_b",
  name: "Layout B",
  ...
  sourceImage: "Recon_Mirror_B.png",
  imageCalibration: {
    src: "/map-images/Recon_Mirror_B.png",
    imageWidthPx: 774,
    imageHeightPx: 1182,
    pxOrigin: [14, 112],
