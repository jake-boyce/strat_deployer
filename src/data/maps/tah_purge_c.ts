...
//   scripts/output/tah_purge_c_template_qa.png before fully trusting.
...
export const tahPurgeC: MissionMap = {
  id: "tah_purge_c",
  name: "Layout C",
  ...
  sourceImage: "TAH_Purge_C.png",
  imageCalibration: {
    src: "/map-images/TAH_Purge_C.png",
    imageWidthPx: 790,
    imageHeightPx: 1168,
    pxOrigin: [19, 107],
